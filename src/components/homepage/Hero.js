...
const Hero = () => {
    ...
    return (
        <section
            ...
            className="container-xl bg-image-yellow relative z-10"
        >
            ...
            <div className="flex flex-col md:flex-row py-5 items-center gap-5">
                <div className="lottie-rocketgrid place-items-center mx-auto  max-w-[250px] md:max-w-xs">
                    <LottieRocket />
                </div>
