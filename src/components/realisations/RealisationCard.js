...
const RealisationCard = ({ realisation }) => {
    // console.log(urlForImage(realisation.mainImage).url);
    ...
    return (
        <div className=" bg-slate-800 rounded-box mx-2 flex w-96 max-w-full flex-shrink-0 flex-col justify-center gap-4 p-4 shadow-xl">
            <figure className="relative">
                ...
                <div className="flex items-center justify-between absolute bottom-0 left-0 p-2 w-full">
                    ...
                    <div className="badge badge-secondary">
                        ...
                        {new Date(realisation._createdAt).toLocaleDateString(
                            "fr-fr",
                            {
                                day: "numeric",
                                month: "long",
            ...
            <div className="card-body relative p-5">
                <h2 className="card-title text-white">{realisation.title}</h2>
                <p>{realisation.excerpt}</p>

                <div className="card-actions justify-end">
                    <ClientSideRoute
                        route={`/realisations/${realisation.slug.current}`}
                    >
